...
public class GameManager : MonoBehaviour
{
    ...
    //fields for displaying theplayer info
    ...
    void Start()
    {
        ...
        CurrentPlayerName.text = MainManager.Instance.savedName;
        SetBestPlayer();
    }
    ...
    {
        m_Points += point;
        MainManager.Instance.savedScore = m_Points;
    ...
    {
        int CurrentScore = MainManager.Instance.savedScore;

        if (CurrentScore > BestScore)
        {
            BestPlayer = MainManager.Instance.savedName;
